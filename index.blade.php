...
<section id="banner" style="background: #F9F3EC;">
      ...
      <div class="swiper main-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              <div class="img-wrapper col-md-5">
                <img src="{{url('/assets')}}/images/banner-img.png" class="img-fluid">
              </div>
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              <div class="img-wrapper col-md-5">
                <img src="{{url('/assets')}}/images/banner-img3.png" class="img-fluid">
              </div>
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                <h2 class="banner-title display-1 fw-normal">Best destination for <span class="text-primary">your
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              <div class="img-wrapper col-md-5">
                <img src="{{url('/assets')}}/images/banner-img4.png" class="img-fluid">
              </div>
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                <h2 class="banner-title display-1 fw-normal">Best destination for <span class="text-primary">your
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="{{url('/assets')}}/images/item1.jpg" class="img-fluid rounded-4" alt="image"></a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="{{url('/assets')}}/images/item2.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="{{url('/assets')}}/images/item3.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="{{url('/assets')}}/images/item4.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="{{url('/assets')}}/images/item7.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="{{url('/assets')}}/images/item8.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
    ...
    <div class="container my-5 py-4">
      ...
      <div class="isotope-container row">
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="{{url('/assets')}}/images/item9.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="{{url('/assets')}}/images/item10.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="{{url('/assets')}}/images/item11.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="{{url('/assets')}}/images/item12.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="{{url('/assets')}}/images/item13.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="{{url('/assets')}}/images/item14.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="{{url('/assets')}}/images/item15.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="{{url('/assets')}}/images/item16.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
    ...
    <div class="container">
      <div class="row flex-row-reverse banner-content align-items-center">
        <div class="img-wrapper col-12 col-md-6">
          <img src="{{url('/assets')}}/images/banner-img2.png" class="img-fluid">
        </div>
      ...
      <div class=" swiper bestselling-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="{{url('/assets')}}/images/item5.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="{{url('/assets')}}/images/item6.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
  ...
  <section id="register" style="background: url('{{url('/assets')}}/images/background-img.png') no-repeat;">
    <div class="container ">
    ...
    <div class="container py-5 my-5">
      ...
      <div class="row">
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="{{url('/assets')}}/images/blog1.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="{{url('/assets')}}/images/blog2.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-post.html">
        ...
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="{{url('/assets')}}/images/blog3.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-post.html">
